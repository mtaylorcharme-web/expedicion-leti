...
const CACHE = "aya-v11";
const FILES = ["./", "./index.html", "./css/app.css", "./js/app.js", "./js/config.js", "./js/characters.js", "./js/content-historia-u3.js", "./js/content-fuentes.js", "./js/content-ensenar.js", "./js/content-mundo.js", "./js/content-canciones.js", "./assets/mapa/mundi.jpg", "./assets/musica/himno.mp3", "./assets/fuentes/venecia.jpg", "./assets/fuentes/ruta-seda.jpg", "./assets/fuentes/astrolabio.jpg", "./assets/fuentes/viajes-colon.jpg", "./manifest.webmanifest", "./assets/icon.svg", "./assets/chars/ovaya.png", "./assets/chars/chupaya.png", "./assets/chars/estaya.png", "./assets/chars/estaya-colgando.png", "./assets/escena-selva.jpg"];
