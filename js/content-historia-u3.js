...
window.CONTENT = {
  ...
  plan: [
    { day: 0, label: "Zarpamos", camps: ["c1"], extra: "Bitácora + 3 misiones" },
    { day: 1, label: "Tres culturas", camps: ["c2"], extra: "Tarjetas del campamento 1" },
    { day: 2, label: "La hueste", camps: ["c3"], extra: "Repaso de errores" },
    { day: 3, label: "Líneas de tiempo", camps: ["c4"], extra: "Tarjetas de fechas" },
    { day: 4, label: "Dos mundos + simulacro", camps: ["c5"], extra: "Simulacro completo" }
  ]
};
